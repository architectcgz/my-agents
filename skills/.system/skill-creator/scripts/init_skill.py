...
SKILL_TEMPLATE = """---
name: {skill_name}
description: [TODO: Use when <specific triggers, symptoms, situations, or user phrasings>. Third person. Prefer triggers over workflow/process summary; do not narrate step-by-step how the skill works.]
---
